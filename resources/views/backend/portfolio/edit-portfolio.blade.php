                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter title" name="title" value="{{$portfolio->title}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter category" name="category" value="{{$portfolio->category}}">
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <img style="padding:4px;border:1px solid gray; margin: 10px 0; width:100px;" id="showNoImage" src="@if($portfolio->image) {{asset($portfolio->image)}} @else {{asset('defaults/noimage/no_img.jpg')}} @endif" alt="image">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Website link" name="website_link" value="{{$portfolio->website_link}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input type="checkbox" name="home" class="form-check-input" id="exampleCheck1" value="1" @if($portfolio->home == 1 ) checked @endif >
