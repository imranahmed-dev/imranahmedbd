        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Create Client Say</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter type" name="type" value="{{old('type')}}">
