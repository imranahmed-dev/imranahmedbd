                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="category" placeholder="Enter category" class="form-control" value="{{$course->category}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fee" placeholder="Enter fee" class="form-control" value="{{$course->fee}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="student_enroll" placeholder="Enter student enroll" class="form-control" value="{{$course->student_enroll}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="duration" placeholder="Enter duration" class="form-control" value="{{$course->duration}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="skill_level" placeholder="Enter skill level" class="form-control" value="{{$course->skill_level}}">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" name="short_description">{{$course->short_description}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <img style="padding:4px;border:1px solid gray; margin: 10px 0; width:100px;" id="showNoImage" src="@if($course->image) {{asset($course->image)}} @else {{asset('defaults/noimage/no_img.jpg')}} @endif" alt="image">
